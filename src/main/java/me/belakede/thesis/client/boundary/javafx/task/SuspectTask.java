...
public class SuspectTask extends Task<Void> {

    private static final Logger LOGGER = LoggerFactory.getLogger(SuspectTask.class);
    private final UserService userService;
    private final Suspect suspect;
    private final Room room;
    private final Weapon weapon;

    public SuspectTask(UserService userService, Suspect suspect, Room room, Weapon weapon) {
    ...
    protected Void call() throws Exception {
        ...
        WebTarget webTarget = client.target(userService.getUrl("/game/suspect"));
        ...
        if (response.getStatus() != 200) {
            ...
            throw new RuntimeException("Suspicion failed. Maybe it's not your turn.");
        }
        return null;
    }
}
